...
namespace TestsFootballClub.BLL.Tests
{
    public class TestKlubService
    {
        ...
        public void TestSprawdzIloscKlubow()
        {
            ...
            var unitOfWork = new UnitOfWork(null ,klubRepo, null);
        ...
        {
            Klub klub = new Klub() { IdKlub = Guid.NewGuid(), ArchiwalniPilkarze = null, ObecniPilkarze = new List<Pilkarz>(), Stadion = "Stadion1",  Trofea = "La Liga", Nazwa = "Klub1", Zarzad = new Zarzad() };
            Klub klub2 = new Klub() { IdKlub = Guid.NewGuid(), ArchiwalniPilkarze = null, ObecniPilkarze = new List<Pilkarz>(), Stadion = "Stadion2", Trofea = "La Liga",  Nazwa = "Klub2", Zarzad = new Zarzad() };
